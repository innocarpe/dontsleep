...
DontSleep은 macOS 메뉴바 앱입니다. `disablesleep` 을 켜고 끄므로 덮개를
닫아도 맥이 잠들지 않습니다. 배터리든 전원이든 같습니다. 클릭하면 토글,
오른쪽 클릭하면 메뉴입니다.
...
| 왼쪽 클릭 | 켜기 / 끄기 |
| 오른쪽 클릭 | 메뉴 |
| 채워진 노트북 아이콘 | 켜짐 — 덮개를 닫아도 깨어 있음. 내장 화면은 꺼짐 |
...
메뉴바에 두고 씁니다. 가방 전에 끄세요. **로그인 시 열기** 는
